...
const menuItems: {
  ...
  { id: "ai-assistant", label: "AI Assistant", icon: MagicWand01Icon },
  { id: "dashboard", label: "Dashboard", icon: DashboardSquare01Icon },
  { id: "leads", label: "Leads", icon: ChartLineData01Icon },
  { id: "emails", label: "Emails", icon: Mail01Icon },
  ...
  { id: "contacts", label: "Contacts", icon: UserCircleIcon },
];

const bottomItems: { id: string; label: string; icon: IconSvgElement }[] = [
  { id: "help", label: "Help Center", icon: HelpSquareIcon },
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="size-5 rounded bg-primary flex items-center justify-center">
              <HugeiconsIcon icon={Atom01Icon} className="size-3.5 text-primary-foreground" />
            </div>
            <span className="text-sm font-medium">内部工作台</span>
          </div>
        </div>
      </SidebarHeader>
      ...
      <SidebarContent className="px-5">
        <div className="flex items-center gap-3 rounded-lg border border-border p-3 mb-4">
          <div className="flex items-center justify-center size-[34px] rounded-lg bg-emerald-500/10">
            <HugeiconsIcon icon={Atom01Icon} className="size-[22px] text-emerald-500" />
          </div>
